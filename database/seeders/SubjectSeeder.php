...
class SubjectSeeder extends Seeder
{
    public function run()
    {
        $subjects = [
            ...
            // Second Year - Second Semester (Old Curriculum)
            [
                'course_code'  => 'CPT07',
            ...
            [
                'course_code'  => 'GEC11',
                'subject_name' => 'Filipino sa Ibat Ibang Disiplina',
                'lec'          => 3,
                'lab'          => 0,
                'units'        => 3,
                'ojt_hours'    => 0,
            ...
            // Third Year - Second Semester (Old Curriculum)
            [
                'course_code'  => 'CPT11',
            ...
            // OJT subjects — lec/lab/units are 0, ojt_hours carries the actual hours
            [
                'course_code'  => 'OJT01',
