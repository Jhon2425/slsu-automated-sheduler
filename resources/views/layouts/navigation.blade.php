...
<nav x-data="{ mobileOpen: false, userOpen: false }" class="bg-[#0C3B2E] px-4 py-3 shadow-lg relative">
        ...
        <div class="flex items-center space-x-3">
            ...
            <div class="relative" @keydown.escape="userOpen = false">
                <button @click="userOpen = !userOpen"
                    ...
                    <div class="text-centered hidden md:block">
                        ...
                        <p class="text-[#cfe5d0] text-xs font-medium">{{ auth()->user()->email }}</p>
                    </div>
                ...
                <div x-show="userOpen"
                    ...
                    <div class="flex flex-col p-2">
                        @if(auth()->user()->role === 'admin')
                            ...
                            <a href="{{ route('admin.faculty.index') }}" class="px-4 py-2.5 text-sm text-white hover:bg-[#6D9773]/20 rounded-lg transition-all duration-200 hover:translate-x-1 flex items-center space-x-2">
                            ...
                            <a href="{{ route('admin.exam-schedules.index') }}" class="px-4 py-2.5 text-sm text-white hover:bg-[#6D9773]/20 rounded-lg transition-all duration-200 hover:translate-x-1 flex items-center space-x-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                                <span>Exam Schedules</span>
                            </a>
                            <a href="{{ route('admin.archives.index') }}" class="px-4 py-2.5 text-sm text-white hover:bg-[#6D9773]/20 rounded-lg transition-all duration-200 hover:translate-x-1 flex items-center space-x-2">
                        ...
                        @elseif(auth()->user()->role === 'faculty')
                            ...
                            <a href="{{ route('faculty.teaching-load.index') }}" class="px-4 py-2.5 text-sm text-white hover:bg-[#6D9773]/20 rounded-lg transition-all duration-200 hover:translate-x-1 flex items-center space-x-2">
            ...
            <div class="md:hidden">
                <button @click="mobileOpen = !mobileOpen" aria-label="Toggle menu"
                    ...
                    <svg x-show="mobileOpen" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 rotate-90" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg>
                </button>
            </div>
        </div>
    </div>
    ...
    <div x-show="mobileOpen"
        ...
        <div class="px-3 pb-3 space-y-2 bg-white/5 rounded-xl backdrop-blur-sm">
            @if(auth()->user()->role === 'admin')
                <a href="{{ route('admin.dashboard') }}" class="block px-4 py-3 rounded-lg text-base font-medium text-white/80 hover:text-white hover:bg-white/5 transition-all duration-200 flex items-center space-x-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                    <span>Admin Dashboard</span>
                </a>
                <a href="{{ route('admin.faculty.index') }}" class="block px-4 py-3 rounded-lg text-base font-medium text-white/80 hover:text-white hover:bg-white/5 transition-all duration-200 flex items-center space-x-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                    <span>Manage Faculty</span>
                </a>
                <a href="{{ route('admin.schedules.index') }}" class="block px-4 py-3 rounded-lg text-base font-medium text-white/80 hover:text-white hover:bg-white/5 transition-all duration-200 flex items-center space-x-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                    <span>Class Schedules</span>
                </a>
                <a href="{{ route('admin.exam-schedules.index') }}" class="block px-4 py-3 rounded-lg text-base font-medium text-white/80 hover:text-white hover:bg-white/5 transition-all duration-200 flex items-center space-x-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                    <span>Exam Schedules</span>
                </a>
                <a href="{{ route('admin.archives.index') }}" class="block px-4 py-3 rounded-lg text-base font-medium text-white/80 hover:text-white hover:bg-white/5 transition-all duration-200 flex items-center space-x-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"/></svg>
                    <span>Archives</span>
                </a>
            @elseif(auth()->user()->role === 'faculty')
                <a href="{{ route('faculty.dashboard') }}" class="block px-4 py-3 rounded-lg text-base font-medium text-white/80 hover:text-white hover:bg-white/5 transition-all duration-200 flex items-center space-x-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                    <span>Faculty Dashboard</span>
                </a>
                <a href="{{ route('faculty.teaching-load.index') }}" class="block px-4 py-3 rounded-lg text-base font-medium text-white/80 hover:text-white hover:bg-white/5 transition-all duration-200 flex items-center space-x-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
                    <span>Teaching Load</span>
                </a>
            @endif
            ...
            <div class="pt-2 mt-2 border-t border-white/10">
                <a href="{{ route('profile.edit') }}" class="block px-4 py-3 rounded-lg text-base font-medium text-white/80 hover:text-white hover:bg-white/5 transition-all duration-200 flex items-center space-x-2">
