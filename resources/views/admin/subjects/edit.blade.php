...
<div x-show="openEditModal"
    ...
    <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div x-show="openEditModal"
            ...
            <!-- Modal Body -->
            <form method="POST" :action="`{{ route('admin.subjects.index') }}/${editSubject.id}`">
                @csrf
                @method('PUT')
                ...
                <div class="px-6 py-6 space-y-5 max-h-[60vh] overflow-y-auto custom-scrollbar">
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            <select name="program_id" required
                                x-model="editSubject.program_id"
                    ...
                    <div class="group">
                        ...
                        <input type="text" 
                            name="course_code" 
                            required
                            x-model="editSubject.course_code"
                    ...
                    <div class="group">
                        ...
                        <input type="text" 
                            name="subject_name" 
                            required
                            x-model="editSubject.subject_name"
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                <select name="year_level" required
                                    x-model="editSubject.year_level"
                                    class="w-full px-4 py-3 rounded-xl bg-white/15 backdrop-blur-sm border border-white/30 text-white
                                           focus:outline-none focus:border-yellow-500 focus:ring-2 focus:ring-yellow-500/20
                                           transition-all duration-300 appearance-none cursor-pointer
                                           hover:bg-white/20 hover:border-yellow-400/50">
                    ...
                    <div class="bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-xl p-4
                                hover:from-blue-500/25 hover:to-cyan-500/25 transition-all duration-300
                                animate-fade-in shadow-lg shadow-blue-500/10">
                        <div class="flex items-start">
                            <i class="fas fa-info-circle text-blue-300 mt-1 mr-3 animate-pulse"></i>
                            <div class="text-sm text-blue-200">
                                <strong class="text-blue-100">Note:</strong> This subject is linked to a specific program. Only faculty members enrolled in this program will have access to this subject.
                            </div>
                        </div>
                    </div>
