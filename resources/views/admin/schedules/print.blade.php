...
<title>Class Schedule — SLSU Tiaong Campus</title>
...
/* Room + Faculty row */
.sb-row{display:flex;flex-wrap:wrap;gap:1px 6px;margin-top:2px;}
.sb-tag{
...
/* Type badge + year + time row */
.sb-bdg{display:flex;align-items:center;gap:3px;margin-top:2px;flex-wrap:wrap;}
.sb-type{
    font-size:7px;font-weight:800;letter-spacing:.08em;
    padding:1px 4px;border-radius:2px;
    background:rgba(0,0,0,.1);text-transform:uppercase;
}
.sb-time{
    font-family:'DM Mono',monospace;
