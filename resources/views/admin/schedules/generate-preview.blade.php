                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <div>
                                                        <div class="text-sm font-medium text-gray-900">
                                                            {{ $schedule->faculty ? $schedule->faculty->name : ($schedule->faculty_name ?? 'N/A') }}
                                                        </div>
                                                        <div class="text-xs text-gray-500">{{ $schedule->class_type ?? 'N/A' }}</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4">
                                                <div class="text-sm font-medium text-gray-900">
                                                    {{ $schedule->subject ? $schedule->subject->subject_name : ($schedule->course_subject ?? 'N/A') }}
                                                </div>
                                                <div class="text-xs text-gray-500">
                                                    {{ $schedule->subject ? $schedule->subject->course_code : ($schedule->course_code ?? 'N/A') }}
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                                                    <i class="fas fa-door-open mr-1"></i>
                                                    {{ $schedule->classroom ? $schedule->classroom->room_name : 'N/A' }}
                                                </span>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold
                                                    @if($schedule->day_name == 'Monday') bg-blue-100 text-blue-800
                                                    @elseif($schedule->day_name == 'Tuesday') bg-green-100 text-green-800
                                                    @elseif($schedule->day_name == 'Wednesday') bg-yellow-100 text-yellow-800
                                                    @elseif($schedule->day_name == 'Thursday') bg-purple-100 text-purple-800
                                                    @elseif($schedule->day_name == 'Friday') bg-pink-100 text-pink-800
                                                    @elseif($schedule->day_name == 'Saturday') bg-indigo-100 text-indigo-800
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                @php
                                                    try {
                                                        ...
                                                        $dateFormatted = $schedule->schedule_date ?? 'N/A';
                                                    }
                                                @endphp
                                                {{ $dateFormatted }}
                                            </td>
